...
import user.Test.steps.AddSessionSteps;

public class AddSessionEmbedder extends Embedder {
	    ...
	    public InjectableStepsFactory stepsFactory() {
	        return
	        	new InstanceStepsFactory(
	        		configuration(), new AddSessionSteps());
	    }
		...
		private StoryReporterBuilder getStoryReporterBuilder() {
	        ...
	        Class<? extends AddSessionEmbedder> embedderClass =
	            this.getClass();
